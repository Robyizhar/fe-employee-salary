...
import { imagePreview, storeData, updateData, setStatus, getDepartementRow, setInput } from '../../../reduce/departement/actions';
...
const Form = () => {
    ...
    React.useEffect(() => {
        if (params.id) {
            ...
            let result = dispatch(getDepartementRow(params.id));
