...
import { getData, saveData, detailData, editData } from '../../api/blogAPI';
...
export const fetchData = () => {
    return  async (dispatch, getState) => {
        ...
        let perPage = getState().blogs.perPage || '';
        let currentPage = getState().blogs.currentPage || 1;
        let keyword = getState().blogs.keyword || '';
